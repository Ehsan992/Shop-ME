  ...
  <section class="content-main">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <div class="card card-body mb-4">
          <article class="icontext">
            <span class="icon icon-sm rounded-circle bg-warning-light"><i class="text-warning fa fa-ticket"></i></span>
            <div class="text">
              <h6 class="mb-1 card-title">Pending Ticket</h6> <span>{{ $tickets }}</span>
              <span class="text-sm">
                In 19 Categories
              </span>
            </div>
